  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> otpPageUsersRecordList = snapshot.data!;
        final otpPageUsersRecord = otpPageUsersRecordList.isNotEmpty
            ? otpPageUsersRecordList.first
            : null;
                  ...
                  Padding(
                    ...
                    child: PinCodeTextField(
                      ...
                      pinTheme: PinTheme(
                        ...
                        inactiveColor: FlutterFlowTheme.of(context).info,
                        selectedColor: FlutterFlowTheme.of(context).secondary,
                        activeFillColor: FlutterFlowTheme.of(context).accent2,
                        inactiveFillColor: FlutterFlowTheme.of(context).info,
                        selectedFillColor:
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (otpPageUsersRecord != null) {
                          if (otpPageUsersRecord.groups.isNotEmpty) {
                            context.pushNamedAuth(
                              'HomePage',
                              context.mounted,
                              queryParameters: {
                                'selectedGroupRef': serializeParam(
                                  otpPageUsersRecord.groups.first,
