            ...
            drawer: StreamBuilder<List<GroupsRecord>>(
              stream: queryGroupsRecord(
                queryBuilder: (groupsRecord) => groupsRecord.where(
                  'Users',
                  arrayContains: homePageUsersRecord?.reference,
                ),
              ),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                                    ...
                                    children: [
                                      Stack(
                                        children: [
                                          ...
                                          if (homePageUsersRecord?.image !=
                                                  null &&
                                              homePageUsersRecord?.image != '')
                                            Padding(
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<GroupsRecord>(
                            stream:
                                GroupsRecord.getDocument(_model.selectedGroup!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    ...
                                    extra: <String, dynamic>{
                                      ...
                                      'userDocument': homePageUsersRecord,
                                    },
                                  );
                                },
                                child: Row(
