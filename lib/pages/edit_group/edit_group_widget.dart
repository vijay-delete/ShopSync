                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    setState(() {
                                      _model.addToUsers(_model.queriedUser!);
                                    });
                                    setState(() {
                                      _model
                                          .addToAddedUsers(_model.queriedUser!);
                                    });
                                    setState(() {
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      while (_model.addedUsers.isNotEmpty) {
                        ...
                        setState(() {
                          _model.removeFromAddedUsers(_model.addedUsers.first);
                        });
                      }
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      while (_model.groupItems.isNotEmpty) {
                        ...
                        setState(() {
                          _model.removeFromGroupItems(_model.groupItems.first);
                        });
                      }
                      setState(() {
                        _model.isDataUploading = false;
