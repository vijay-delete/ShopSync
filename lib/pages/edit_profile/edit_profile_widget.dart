...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        _model.groups = _model.userGroups!.toList().cast<GroupsRecord>();
      });
    });
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Builder(
                        builder: (context) {
                          final groupsList = _model.groups.toList();
                          return ListView.separated(
                            ...
                            itemBuilder: (context, groupsListIndex) {
                              final groupsListItem =
                                  groupsList[groupsListIndex];
                              return Padding(
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            setState(() {
                                              _model.removeFromGroups(
                                                  groupsListItem);
                                              _model.addToRemovedGroups(
                                                  groupsListItem);
                                            });
                                          },
                                          child: Icon(
                    ...
                    onPressed: () async {
                      ...
                      await currentUserReference!.update({
                        ...createUsersRecordData(
                          ...
                          photoUrl: _model.profileImage,
                          displayName: _model.textController1.text,
                        ),
                        ...mapToFirestore(
                          {
                            'Groups':
                                _model.groups.map((e) => e.reference).toList(),
                          },
                        ),
                      });
                      while (_model.removedGroups.isNotEmpty) {
                        if (_model.removedGroups.first.users.length <= 1) {
                          await _model.removedGroups.first.reference.delete();
                        } else {
                          await _model.removedGroups.first.reference.update({
                            ...mapToFirestore(
                              {
                          ...
                          if (currentUserReference ==
                            ...
                            await _model.removedGroups.first.reference
                              ...
                              groupAdmin:
                                  _model.removedGroups.first.users.first,
                            ));
                          }
                        }

                        setState(() {
                          _model.removeFromRemovedGroups(
                              _model.removedGroups.first);
                        });
                      }
                      if (widget.selectGroupRef != null) {
                        context.pushNamed(
                          'HomePage',
                          queryParameters: {
                            'selectedGroupRef': serializeParam(
                              widget.selectGroupRef,
                              ParamType.DocumentReference,
                            ),
                          }.withoutNulls,
                        );
                      } else {
                        _model.updatedUser = await UsersRecord.getDocumentOnce(
                            currentUserReference!);
