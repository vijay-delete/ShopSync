                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 10.0),
                                child: Text(
                                  'Ready to streamline your family\'s shopping experience? 🛒 Let\'s make it happen! Create your first group to get started',
                              ...
                              Padding(
                                ...
                                child: Stack(
                                  children: [
                                    if (_model.queriedUser?.displayName !=
                                            null &&
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (_model.selectedPhoneNumber !=
                                            ...
                                            if (_model.qeriedUserByContacts
                                                        ?.uid !=
                                                    null &&
                                                _model.qeriedUserByContacts
                                                        ?.uid !=
                                                    '') {
                                              setState(() {
                                                _model.addToUsers(_model
                                                    .qeriedUserByContacts!);
                                              });
                                            } else {
                                              await showDialog(
                                                context: context,
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    while (_model.users.isNotEmpty) {
                                      await _model.users.first.reference
                                          .update({
                                        ...mapToFirestore(
                                          {
