...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child: appStateNotifier.loggedIn ? const HomePageWidget() : const EntryPageWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) =>
              appStateNotifier.loggedIn ? const HomePageWidget() : const EntryPageWidget(),
        ),
        FFRoute(
          name: 'SignUpPage',
          path: '/signUpPage',
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'item': getDoc(['Items'], ItemsRecord.fromSnapshot),
          },
        ...
        FFRoute(
          ...
          path: '/joinGrouByLink',
          requireAuth: true,
          builder: (context, params) => JoinGrouByLinkWidget(
            groupRef: params.getParam(
                'groupRef', ParamType.DocumentReference, false, ['Groups']),
          ),
        )
